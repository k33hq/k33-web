  ...
  return (
    <>
      <NextSeo
        ...
        title={'Research - Monthly Outlook'}
        description={''}
        twitter={{
          handle: siteUsername,
        ...
        openGraph={{
          title: 'Research - Monthly Outlook',
          description: '',
          url: `https://${process.env.NEXT_PUBLIC_WEB_DOMAIN}/research/monthly-outlook`,
...
> = async () => {
  const articles = await getArticleSummaryWidgets('monthly-outlook');
  return {
    props: {
      articles,
    },
