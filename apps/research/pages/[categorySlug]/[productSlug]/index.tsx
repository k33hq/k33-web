...
import { getProductBySlug, getProductSlugsByCategory } from '@/api/products';
import { getArticleElementsByProductAndCategories } from '@/api/articles';
import {
  ArticleElements,
  CategorySlug,
  ProductCoreSlug,
...
import { ArticleElement } from '@/components/articles';
