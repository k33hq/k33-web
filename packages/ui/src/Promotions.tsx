...
export const BasicPromotion: React.FC<BasicPromotionProps> = ({
  ...
  return (
    <div className="ui-flex ui-flex-row ui-gap-20 ui-items-center ui-justify-between">
      {direction === 'left' ? image : null}
      <div className="ui-flex ui-flex-col ui-gap-2">
        <p className="ui-text-heading4 ui-text-label-light-primary">{title}</p>
        <p className="ui-text-body1 ui-text-label-light-secondary">
          {description}
        </p>
        <div className="ui-flex ui-flex-col ui-gap-9 ui-pt-7 ui-justify-center">
          {points.map((point) => (
            <div
              key={point}
              className="ui-flex ui-flex-row ui-items-center ui-gap-2"
            >
              <div className="ui-w-10 ui-h-9">
                <svg
              ...
              <p className="ui-text-heading8 ui-text-label-light-secondary">
                {point}
              </p>
            </div>
          ))}
