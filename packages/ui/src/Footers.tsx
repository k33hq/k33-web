  ...
  return (
    ...
    >
      <div
        ...
        className="ui-flex ui-flex-row md:ui-container ui-pt-8 ui-items-center ui-justify-between"
      >
        {logo}
      ...
      <div
        id="footer-end"
        className="ui-flex ui-flex-row ui-items-center ui-justify-center ui-gap-2"
      >
        <p className="ui-text-small ui-text-label-light-tertiary">
          © All rights reserved to K33
        </p>
        <Dot />
        <p className="ui-text-small ui-text-label-light-tertiary">Made with</p>
        <svg
          width="16"
          height="14"
          viewBox="0 0 16 14"
